-- gui.lua
-- Рабочая версия с явным созданием элементов через Tab:CreateSection и последующие вызовы
...
function GUI:CreateWindow(Rayfield)
    ...
    -- Сохраняем вкладки в self для дальнейшего использования
    self.MainTab = Window:CreateTab("Main", 4483362458) -- ID иконки (можно nil)
